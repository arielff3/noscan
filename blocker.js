...
/*  NO‑SCAN  v0.3.2
    ...
    (() => {
      ...
      const log = (...a) => CFG.debug && CFG.enabled && console.log('%cNO‑SCAN', 'color:blue', ...a);
      ...
      function installListenersOnce() {
        ...
        const keyHandler = e => {
          ...
          if ((e.ctrlKey || e.metaKey) && SHORTCUT_KEYS.includes(e.key.toLowerCase())) {
            e.stopImmediatePropagation();
        ...
        const protos = [Window.prototype, Document.prototype, HTMLElement.prototype];
        const blockProp = p => protos.forEach(pr =>
